...
This will create the folder which is given as first parameter , then create a log file in it and 
send the log file as attachement to the given email id.
